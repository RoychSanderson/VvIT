...
*/
  ...
  class Animals (val name: String, val species: String, val food: String){
    def eats(food: String): Boolean = this.food == food
  }
  object Animals{
    val cat: Animals = new Animals("cat", "mammal", "meat")
    val parrot: Animals = new Animals("parrot", "bird", "vegetables")
    val goldfish: Animals = new Animals("cat", "fish", "plants")
  }
  trait Animal{
    val name: String
    val food: Food
    def eats: Boolean = this.food == food
  }
  trait Food
  ...
  def main(args: Array[String]): Unit = {
    println(Animals.cat.eats("meat"))
    val dog: Animals = new Animals("dog", "mammal", "meat")
    println(dog.eats("meat"))
    println(Animal.knownAnimal("parrot"))
    println(Animal.apply("cat").isEmpty)
    println(Food.apply("juice").isEmpty)
