...
object Compositions {
  ...
  def main(args: Array[String]): Unit = {
    println("Compose = " + testCompose((x: Int) => x * 2)((x: Int) => x + 1)((x: Int) => x * x)(5))
    println("MapFlatMap = " + testMapFlatMap((x: Int) => Some(x * 2))((x: Int) => Some(x + 1))((x: Int) => x * x)(Some(5)))
    println("MapFlatMap = " + testMapFlatMap((x: Int) => Some(x * 2))((_: Int) => None())((x: Int) => x * x)(Some(5)))
    println("ForComprehension = " + testForComprehension((x: Int) => Some(x * 2))((x: Int) => Some(x + 1))((x: Int) => x * x)(Some(5)))
    println("ForComprehension = " + testForComprehension((x: Int) => Some(x * 2))((_: Int) => None())((x: Int) => x * x)(Some(5)))
  }
}
